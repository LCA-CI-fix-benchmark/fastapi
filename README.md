...
<p align="center">
<a href="https://github.com/tiangolo/fastapi/actions?query=workflow%3ATest+event%3Apush+branch%3A* Check that it has an optional attribute `is_offer` which, if present, should be a `bool`.aster" target="_blank">

...
<p align="center">
<a href="https://github.com/tiangolo/fastapi/actions?query=workflow%3ATest+event%3Apush+b* Validate that the `item_id` is of type `int` for `GET` and `PUT` requests.
...
* Document everything with OpenAPI, that can be used by:er" target="_blank">
